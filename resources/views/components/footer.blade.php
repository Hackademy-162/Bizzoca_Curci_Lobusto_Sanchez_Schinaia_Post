    ...
    <div class="container p-4">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          <h5 class="text-uppercase text-center text-white">Contattaci</h5>
          <ul class="list-unstyled mb-2 text-center ">
            ...
            <li>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-google text-white" viewBox="0 0 16 16">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled pt-3">
            ...
            <li>
              <a href="#!" class="text-white text-decoration-none">Sede legale: Via Milano, 1</a>
            </li>
            <li>
              <a href="#!" class="text-white text-decoration-none">Servizio clienti 12345678</a>
            </li>
          </ul>
        </div>
        <!--Grid column-->
